...
function App() {
  ...
  return (
    ...
    <div className="">
      ...
      <button onClick={()=> setToggle(false)} className={`p-3 px-4 border-2 border-l-0 border-gray-400 rounded-r-lg font-semibold text-[#13131380] ${toogle=== false? "bg-[#E7FE29]": ""}`}> Selected <span>(0)</span></button>
    </div>
